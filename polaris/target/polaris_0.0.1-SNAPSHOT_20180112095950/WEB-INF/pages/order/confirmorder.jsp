...
<head>
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            ...
            $("#datagrid").datagrid("options").url = "${path}/order/datagridqr?" + $("#fmorder").serialize();
        ...
        //确认订单
        function formatsfqr(val, row) {
            if(row.sfqr=='2' || row.sfqr=='' || row.sfqr==null ){
                return '<a class="editcls" href="javascript:void(0)" onclick="editRow(\'' + row.id + '\')" >确认订单</a>';
            }
        }

        function editRow(id) {
            $.messager.confirm("提示", "若订单无误，请确认库存？", function (r) {
                if (r) {
                    $.post('${path}/order/confirmorder',
                    {id: id},
                    function (result) {
...
<div region="center" border="false" style="overflow: hidden;">
    <!-- 信息列表 -->
    <table id="datagrid" title="订单确认" class="easyui-datagrid" fit="true" toolbar="#toolbar" pagination="true"
        ...
        <tr>
            ...
            <th field="sfqr" width="80" align="center" formatter="sfqr">订单确认</th>
            <th field="opt" width="100" align="center" formatter="formatsfqr">操作</th>
        </tr>
        </thead>
    </table>
    ...
    <div id="toolbar" class="easyui-layout"
        ...
        <form id="fmorder" name="fmorder" method="post">
            <div style="padding-top:6px;padding-bottom: 6px;padding-left: 6px;padding-right: 6px">
                ...
                &nbsp;
                <label>确认状态:</label> <input id="sfqr" name="sfqr" class="easyui-combobox" style="width: 80px"
                                            data-options="panelHeight:'auto', editable:false,valueField:'id',textField:'text',
