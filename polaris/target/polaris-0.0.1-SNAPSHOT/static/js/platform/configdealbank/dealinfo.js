...
window.onload = function () {
    $("#datagrid").datagrid("options").url = getRootPath() +
        "/configdealbank/datagridDetail?cardBankName=" + $('#hcardBankName').val()
        ...
        success: function(result) {
            ...
            if (result.success) {
                ...
                $("#datagrid").datagrid("options").url
                    = getRootPath() + "/configdealbank/datagridDetail?cardBankName=" + $('#hcardBankName').val() + '&cardType=' + $('#hcardType').val();
    ...
    $.post(getRootPath() + '/configdeal/upConfigDealState',
        ...
        function (result) {
            ...
            if (result.success) {
                ...
                $("#datagrid").datagrid("options").url = getRootPath() + "/configdealbank/datagridDetail?cardBankName=" + $('#hcardBankName').val() + '&cardType=' + $('#hcardType').val();
                $("#datagrid").datagrid("load");
            } else {
...
function searchOrder() {
    $("#datagrid").datagrid("options").url
        = getRootPath() + "/configdealbank/datagridDetail?" + $("#fmorder").serialize();
    $("#datagrid").datagrid("load");
}
