...
<head>
    ...
    <script type="text/javascript">
        ...
        function formatbackorder(val, row) {
            if(row.ddbz=='05'){
                return '<a class="editcls" href="javascript:void(0)" onclick="editRow(\'' + row.id + '\')" >同意退单</a>';
            }
        }

        function editRow(id) {
            $.messager.confirm("提示", "如果确认是货品问题，请同意退货？", function (r) {
                if (r) {
...
<div region="center" border="false" style="overflow: hidden;">
    ...
    <table id="datagrid" title="退单查询" class="easyui-datagrid" fit="true" toolbar="#toolbar" pagination="true"
        ...
        <tr>
            ...
            <th field="ddbzmc" width="80" align="center" style="color: red">订单标志</th>
            <th field="opt" width="100" align="center" formatter="formatbackorder">操作</th>
        </tr>
        </thead>
    </table>
