...
window.onload = function () {
    $('#datagrid').datagrid({
        url: getRootPath() + "/instalbankinfo/datagrid",
        columns: [[
...
function searchOrder() {
    $("#datagrid").datagrid("options").url = getRootPath()+ "/instalbankinfo/datagrid?" + $("#fmorder").serialize();
...
function saveConfig() {
    $.ajax({
        type: "POST",
        url:getRootPath() + "/instalbankinfo/addBankInfo",
...
function save() {
    ...
    var record = $("#datagrid").datagrid('getSelected');
    $.post(getRootPath()+'/instalbankinfo/upBankInfoState',
...
function copyConfig() {
    ...
    if (row) {
        $.post(getRootPath()+'/instalbankinfo/selectBankInfo',
