...
<head>
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            $('#datagrid').datagrid({
                url: "${path}/instalbankinfo/datagrid",
                columns: [[
        ...
        function searchOrder() {
            $("#datagrid").datagrid("options").url = "${path}/instalbankinfo/datagrid?" + $("#fmorder").serialize();
        ...
        function saveConfig() {
            $('#configfm').form('submit', {
                url: path + "/instalbankinfo/addBankInfo",
                onSubmit: function () {
        ...
        function save() {
            ...
            var record = $("#datagrid").datagrid('getSelected');
            $.post('${path}/instalbankinfo/upBankInfoState',
        ...
        function copyConfig() {
            ...
            if (row) {
                $.post('${path}/instalbankinfo/selectBankInfo',
