...
<head>
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            ...
            $('#openRoleDiv').dialog({
                onClose: function () {
                    $("#datagrid").datagrid("options").url = "${path}/configdeal/datagrid?" + $("#fmorder").serialize();
        ...
        function onReset() {
            ...
            $("#datagrid").datagrid("options").url = "${path}/configdeal/datagrid";
            $("#datagrid").datagrid("load");
        }


        function editRow(dealchannel, strategy, dealSubChannel, sourceSubChannel) {
            $('#iframe1')[0].src = '${path}/configdeal/dealinfo?dealChannel=' + dealchannel
...
<div region="center" border="false" style="overflow: hidden;">
    ...
    <table id="datagrid" title="路由策略管理" class="easyui-datagrid" fit="true"
           url="${path}/configdeal/datagrid" toolbar="#toolbar" pagination="true"
