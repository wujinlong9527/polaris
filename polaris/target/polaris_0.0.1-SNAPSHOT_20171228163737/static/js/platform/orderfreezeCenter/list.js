...
function searchOrder() {
    ...
    var orifcOrderId=document.getElementById("orifcOrderId").value;
    if((orifcOrderId == null || orifcOrderId == '')&&(fcOrderid == null || fcOrderid == '')&&(fullName== null || fullName == '')&&(phone == null || phone == '')&&(cardNo == null || cardNo == '')&&(payOrderid == null || payOrderid == ''))
    {
        alert("orifcOrderId、fcOrderid、姓名、手机号、银行卡号、银联流水号,请至少输入一项进行查询!");
        return;
    }
