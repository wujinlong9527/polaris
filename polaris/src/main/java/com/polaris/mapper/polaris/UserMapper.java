...
public interface UserMapper {
    ...
    public void addlog(@Param("ids") String  ids,@Param("userId") String  userId,@Param("account") String  account,
                       @Param("inserttime") String  inserttime,@Param("bz") String  bz);

    public String  getAccountroleid(@Param("account") String account);

    public List<User> getgroupname(@Param("account") String account);
}
