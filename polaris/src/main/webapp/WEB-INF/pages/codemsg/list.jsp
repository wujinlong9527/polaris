...
<head>
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            ...
            $.ajax({
                type: "POST",
                url: "${path}/codemsg/selectDealSubChannel",
                cache: false,
                dataType: "json",
            ...
            $.ajax({
                type: "POST",
                url: "${path}/codemsg/getLocalCodeList",
                cache: false,
                dataType: "json",
                success: function (data) {
        ...
        function searchOrder() {
            ...
            $("#datagrid").datagrid("options").url = "${path}/codemsg/datagrid?" + $("#fmorder").serialize();
        ...
        function save() {
            ...
            var record = $("#datagrid").datagrid('getSelected');
            $.post('${path}/codemsg/upCodeMsgState',
                    ...
                    function (result) {
                        ...
                        if (result.success) {
                            ...
                            $("#datagrid").datagrid("options").url = "${path}/codemsg/datagrid";
                            $("#datagrid").datagrid("load");
                        } else {
        ...
        function editConfig() {
            ...
            if (row) {
                $.post('${path}/codemsg/selectCodeMsg',
                        {gid: row.gid},
                        function (result) {
                            var result = eval('(' + result + ')');
                            if (result.success) {
...
<div region="center" border="false" style="overflow: hidden;">
    ...
    <table id="datagrid" title="错误码管理" class="easyui-datagrid" fit="true"
           url="${path}/codemsg/datagrid" toolbar="#toolbar" pagination="true"
           fitColumns="false" singleSelect="fasle" rownumbers="true"
    ...
    <div id="toolbar" class="easyui-layout"
        ...
        <form id="fmorder" name="fmorder" method="post">
            <div style="padding-top:6px;padding-bottom: 6px;padding-left: 6px;padding-right: 6px">
                ...
                <label>渠道信息:</label> <input id="msg" name="msg" class="easyui-textbox"
                                            style="width: 150px">
                <label>本地信息:</label> <input id="localMsg" name="localMsg" class="easyui-textbox"
                                            style="width: 150px">
