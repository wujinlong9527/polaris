    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            $("#datagrid").datagrid("options").url
                    = "${path}/configdeal/datagridDetail?dealSubChannel=" + $('#hdealSubChannel').val() + "&strategy=" + $('#hstrategy').val();
            ...
            $.post('${path}/configdeal/upConfigDealState',
                    ...
                    function (result) {
                        ...
                        if (result.success) {
                            ...
                            $("#datagrid").datagrid("options").url = "${path}/configdeal/datagridDetail?dealSubChannel=" + $('#hdealSubChannel').val() + "&strategy=" + $('#hstrategy').val();
                            $("#datagrid").datagrid("load");
                        } else {
        ...
        function searchOrder() {
            $("#datagrid").datagrid("options").url
                    = "${path}/configdeal/datagridDetail?dealSubChannel=" + $('#hdealSubChannel').val()
...
<div region="center" border="false" style="overflow: hidden;">
    ...
    <table id="datagrid" class="easyui-datagrid" fit="true"
        ...
        <tr>
            ...
            <th field="minMoney" width="80" align="right">最小金额</th>
            <th field="maxMoney" width="100" align="right">最大金额</th>
    ...
    <div id="toolbar" class="easyui-layout"
        ...
        <form id="fmorder" name="fmorder" method="post">
            <div style="padding-top:6px;padding-bottom: 6px;padding-left: 6px;padding-right: 6px">
                <label>银行名称:</label> <input id="scardBankName" name="cardBankName" class="easyui-textbox"
                                            style="width: 150px">
                ...
                <span style="color:green; float: right;font-size:14px"><span
                        style="color:black;">处理子渠道：</span>${configdeal.dealSubChannel}&nbsp&nbsp<span
                        style="color:black;">策略：</span>${configdeal.strategy}&nbsp&nbsp<span
                        style="color:black;">来源子渠道：</span>${configdeal.sourceSubChannel}</span>
            </div>
        </form>
        ...
        <input id="hdealChannel" name="dealChannel" type="hidden" value="${configdeal.dealChannel}"></td>
        <input id="hdealSubChannel" name="dealSubChannel" type="hidden" value="${configdeal.dealSubChannel}"></td>
    </div>
